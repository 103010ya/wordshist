...
8. В поле tag каждого примера обязательно напиши название формы на русском, знак «·» и точную корейскую форму изучаемого слова, использованную в предложении. Например: «Настоящее · 해요», «Прошедшее · 했어요», «Будущее · 할 거예요», «Желание · 하고 싶어요». Не пиши только название времени и не указывай одно окончание в скобках.
9. Не используй markdown и не добавляй поля, которых нет в заданной структуре.
`;
}
